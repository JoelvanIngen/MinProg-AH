...
class Node:
    def __init__(self, protein: 'Protein', _id: int, letter: str, x: int, y: int, z: int, direction: int | None,
    ...
    @classmethod
    def from_previous(cls, protein: 'Protein', _id, c, direction: int, prev: 'Node'):
