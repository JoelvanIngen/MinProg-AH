...
def main():
    ...
    for _ in tqdm(range(N)):
        ...
        algorithm = SimulatedAnnealingHeuristics(protein, dimensions=2, show_progressbar=False)
        score = algorithm.run()
        scores.append(score)
    ...
    plt.title(f'Simulated Annealing with Average and Min')
    plt.legend()
    plt.savefig('output/SimulatedAnnealingStats')
